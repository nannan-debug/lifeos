...
| `1.11.0` (build 15) | ✅ 已上架 | 2026-05-26 上架。中英文双语支持 + AI 语言匹配；1.9.0 和 1.10.0 改动随本版本一起发布 |
| `1.12.0` (build 16) | ✅ 已上架 | 2026-06-04 上架。DBT 修复 + Agent 对话体验优化 |
| `1.13.0` (build 17) | ✅ 已上架 | 2026-06-14 上架。猫猫首次问卷、人设设置、分层记忆与情绪梳理体验优化 |
