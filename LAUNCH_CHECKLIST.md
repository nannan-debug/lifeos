...
**LifeOS 1.11.0 (build 15) 已通过审核并上架；1.12.0 (build 16) 已上传 App Store Connect 并提交 Apple 审核，等待审核结果。**
...
- 🟡 `1.12.0 (build 16)` — 2026-06-04 已提交 App Review，等待 Apple 审核结果
- ✅ App ID：`6763877227`
- ✅ App Store Connect 状态：1.0.0 ~ 1.11.0 均 Ready for Distribution；1.12.0 (build 16) 已提交审核，尚未上架
...
| 当前提审版本 | `1.12.0` (build 16) 已提交 App Review，等待 Apple 审核 |
| 当前 main 状态 | `1.12.0 (build 16)` 发版 PR 已合并；build 16 已上传并提交审核，尚未上架 |
