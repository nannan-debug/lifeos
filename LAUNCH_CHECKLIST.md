...
**LifeOS 1.5.1 (build 8) 已通过审核并上架；`v1.5.2 (build 9)` 已提交 App Review，等待 Apple 审核结果。**
...
- 🟡 `1.5.2 (build 9)` — 已提交审核，等待 Apple 结果（首屏背景修复、待办识别与交互优化、时间记录删除、设置页降噪、CSV 打卡导出、第二大脑失败日志）
- ✅ App ID：`6763877227`
- ✅ App Store Connect 状态：1.0.0 / 1.1.0 / 1.2.0 / 1.3.0 / 1.4.0 / 1.5.0 / 1.5.1 均 Ready for Distribution

**当前阶段：`1.5.2 (build 9)` 已完成代码合并、Archive / Upload / Submit to App Review；等待 Apple 审核结果。**
...
| 当前 main 状态 | `1.5.2` (build 9) 已合入 main，并已提交 App Review；等待 Apple 审核结果 |
...
- ⏳ 等待 Apple 审核结果；尚未 Ready for Distribution / 上架。
...
**LifeOS 1.0.0（2026-04 首发）/ 1.1.0 (build 3, 2026-04-30) / 1.2.0 (build 4, 2026-05-02) / 1.3.0 (build 5, 2026-05-03) / 1.4.0 (build 6, 2026-05-04) / 1.5.0 (build 7, 2026-05-07) / 1.5.1 (build 8, 2026-05-11) 均已在 App Store 在线。`1.5.2 (build 9)` 已合入 main，并已 Submit to App Review（2026-05-11，用户确认）；等待 Apple 审核结果。`v1.5.2` tag 和 GitHub Release 需等 App Store Ready for Distribution 后再做。**
